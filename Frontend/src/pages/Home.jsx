  ...
  return (
    ...
    <section>
        <div className='left'>
           ...
           <button onClick={addRecipe} style={{ color: 'white', backgroundColor: 'black' }}>Share your recipe</button>
